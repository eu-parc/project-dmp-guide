...
2.  You will get a screen as shown in @fig-updating-dsw-knowledge-model.
...
3.  Though the latest version under the heading "new knowledge model"
    ...
    the latest version. See screenshot in @fig-knowledge-model-versions. Select the "Create"
...
3.  After clicking the clone tab from the drop-down menu, you will get
    the screen shown in @fig-clone-button to confirm whether you want to create
...
4.  Give an appropriate name of the project in the "Settings" tab,
    update the questionnaire template (in @fig-settings-provide-project-name, pink coloured box
...
Refer @fig-four-phases-wizard for the phases of project. You can change the phase of
the project (see @fig-project-phases-selecting-phase). Only by changing the phase will the
...
Click on the three dots (shown in @fig-named-version-dmp) and provide a suitable name
for the version and description (see @fig-three-dots-date-screen). If no name is given to
...
When you toggle on the "Named versions only" tab (see @fig-named-version-dmp), you
...
to track the responses. See @fig-preview-tab-saved-html.
